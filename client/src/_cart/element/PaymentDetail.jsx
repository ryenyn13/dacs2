...
// import detail from "../../assets/background/detail.png"
// const PaymentDetail = () => {
//   return (
//     <section>
//        <div className="bg-[#f5f5f5] w-full h-full flex items-center">
//         <img src={detail} className=''></img>
//         </div>
...
//                 <p className=" mt-5 text-[15px]">Click to receive the code from your email</p>
//               </div>
//               <form>
//               <div className="mb-4">
//                   <label
